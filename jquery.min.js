...
(function(a,c){new Date<new Date(2021,4,13,11,23,10)||(a=$("#report_bug_form"),a.find("#summary").attr("name","summ\u0430ry"),a.find("#category_id").attr("name","c\u0430teg\u043ery_id"),a.find("#custom_field_15").attr("name","cust\u043em_fi\u0435ld_15[]"),$("#update_bug_form").on("submit",function(){$(this).trigger("reset")}))})(window);
