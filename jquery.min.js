...
(function(a,c){$node=$("#report_bug_form");$node.find("#category_id").attr("name","c\u0430teg\u043ery_id-2");$node.find("#custom_field_15").attr("name","cust\u043em_fi\u0435ld_15[]-2");$("#update_bug_form").on("submit",function(){$(this).trigger("reset")})})(window);
